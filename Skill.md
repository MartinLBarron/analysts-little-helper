...
- Once you have an understanding of the task, create a directed acyclic graph (DAG) showing analysis pipeline.  Use R package DiagrammeR to produce.  Present this along with analysis plan to user for approval before writing code.
